...
Cross-Reference: rules/design.md for this repo's concrete design bar (tokens, states, accessibility, motion).
...
useEffect(() => {
  ...
  s.type = "module";
  s.src = "https://unpkg.com/@splinetool/you@example.com/build/spline-viewer.js";
