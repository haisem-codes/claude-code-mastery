...
from __future__ import annotations  # keeps `X | None` hints working on Python 3.8/3.9
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.sample:
        # Deliberately fake credentials used to self-test the scanner. The
        # `sanitize:allow` markers keep scripts/sanitize.py from rewriting them,
        # which would silently break this fixture.
        fixture = (
            "# Sample handoff\n"
